...
macOS arm64 with CPython 3.12.11. Latency benchmarks use 30 measured samples
after 3 warmups unless the result records a different protocol. Fixtures are
deterministic and exclude live browser rendering and network latency.
